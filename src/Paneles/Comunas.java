...
import ModeloTabla.MTComuna;
import Objetos.OError;
import static Ventanas.PanelPrincipal.PanelPrincipal;
import java.awt.BorderLayout;


public class Comunas extends javax.swing.JPanel {

    private CComuna comuna = new CComuna();;
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        OError Insertar = this.comuna.Insertar(txtNombre.getText(),txtCodigo.getText());
    ...
    private void btnOcultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOcultarActionPerformed
        int Eliminar = this.comuna.Eliminar(txtId.getText());
        
        Comunas cms = null;
        cms = new Comunas();
             cms.setSize(1000, 525);
             cms.setLocation(5, 5);
